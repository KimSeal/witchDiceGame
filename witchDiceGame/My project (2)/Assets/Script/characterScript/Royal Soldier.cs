...
public class RoyalSoldier : Character
{
    public RoyalSoldier(int curState, Destiny destiny) : base(curState, destiny)
    {
    ...
    public override List<TakeSkillPacket> doSkill(SendSkillPacket sendSkillPacket)
    {
        ...
        //{
            ...
            {
                packets.Add(new TakeSkillPacket(sendSkillPacket.targetIdx[0], 6 + this.getPhyAtk(), 0));
            }
        //}
        return packets;
    }
