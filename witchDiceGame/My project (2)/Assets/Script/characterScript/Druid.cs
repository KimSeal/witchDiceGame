...
public class Druid : Character
{
    ...
    public override List<TakeSkillPacket> doSkill(SendSkillPacket sendSkillPacket)
    {
        ...
        //{
            ...
            {
                packets.Add(new TakeSkillPacket(sendSkillPacket.targetIdx[0], 4 + this.getPhyAtk(), 0)); //대상이 사용한 주사위 값을 기반으로 Damage를 기반으로
            ...
            if (sendSkillPacket.useSkillIdx == 1) //용사 기본 스킬
            {
                ...
                packets.Add(new TakeSkillPacket(sendSkillPacket.targetIdx[0], finalVal + this.getPhyAtk(), 0));
            }
        //}
        return packets;
    }
